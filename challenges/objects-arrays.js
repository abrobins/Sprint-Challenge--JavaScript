...
console.log("Diet of Velociraptor:");
console.log(velociraptor.diet);

// How long was a stegosaurus?
console.log("Length of Stegosaurus:");
console.log(stegosaurus.length);

// What time period did tyrannosaurus live in?
console.log("Time period of Tyrannosaurus:");
console.log(tyrannosaurus.period);

// Create a new roar method for the tyrannosaurus.  When called, return "RAWERSRARARWERSARARARRRR!" Log the result.
console.log("New ROAR method logged to console:");
...
universities.sort();
console.log("Universities sorted alphabetically:");
...
console.log("Log name and email address:");
console.log(contactInfo);

/* Request 3: Find out how many universities have the string "Uni" included in their name. Create a new array called unisWithUni that contains them all. This will be an array of objects. Log the result. */
const unisWithUni = [];
let fullunisWithUni = graduates.filter(item => item.university.includes("Uni"));

for (let i = 0; i < fullunisWithUni.length; i++) {
  unisWithUni.push(fullunisWithUni[i].university);
  // for (let i = 0; i < graduates.length; i++) {
  //   if (graduates[i].university.includes("Uni")) {
  //     uniswithUni[i] = "{university:" + graduates[i].university + "}";
  //   }
  // }
}
...
console.log("Log scientific name and animal name:");
...
zooAnimals.map(animalname => {
  lowCaseAnimalNames.push(animalname.animal_name.toLowerCase());
});
console.log("Test map function - log animal names:");
...
console.log("Test filter function - log population count array:");
...
populationTotal = zooAnimals.reduce((acc, CurrValue) => {
  return acc + CurrValue.population;
}, 0);
console.log("Test reduce function - log population total:");
